...
const readHostMeta = (): HostMeta => {
    try {
        ...
        if (meta && typeof meta === 'object') {
            const { name, description } = meta as HostMeta;
...
const APP_NAME = HOST_META.name || (import.meta as any).env?.VITE_APP_NAME || 'VidhiOne';
const APP_TAGLINE = HOST_META.description || (import.meta as any).env?.VITE_APP_TAGLINE || APP_NAME;
...
const AppTopbar = forwardRef<AppTopbarRef>((props, ref) => {
    ...
    const hostLogo = typeof window !== 'undefined' ? (window as any).__THEME_LOGO_PATH__ : undefined;
        ...
        <div className="layout-topbar">
            <div className="layout-topbar-start">
                <Link className="layout-topbar-logo" to="/">
                    {hostLogo ? (
                        <>
                            <img src={hostLogo} alt="Logo" className="layout-topbar-logo-full" style={{ height: '32px' }} />
                            <img src={hostLogo} alt="Logo" className="layout-topbar-logo-slim" style={{ height: '32px' }} />
                        </>
                    ) : (
