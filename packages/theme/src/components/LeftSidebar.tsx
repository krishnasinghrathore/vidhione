...
const LeftSidebar: React.FC = () => {
  ...
  return (
    <div className="layout-sidebar bg-blue-800 text-white transition-all duration-300 flex flex-column shadow-2 w-4rem">
      {/* Navigation Items */}
      <div className="layout-menu flex flex-column flex-1 overflow-y-auto">
        {navigationItems.map((item) => (
          <div key={item.id} className="layout-root-menuitem">
            <Button
              icon={`pi ${item.icon}`}
