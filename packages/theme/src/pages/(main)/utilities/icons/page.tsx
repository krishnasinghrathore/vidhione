    ...
    return (
        <div className="card">
            ...
            <p>
                ...
                <a href="https://github.com/primefaces/primeicons" className="font-medium hover:underline text-primary" target={'_blank'} rel="noopener noreferrer">
                    PrimeIcons
                </a>{' '}
                library, the official icons suite from{' '}
                <a href="https://www.primetek.com.tr" className="font-medium hover:underline text-primary" target={'_blank'} rel="noopener noreferrer">
                    PrimeTek
                </a>
                .
            </p>
            ...
            <p>
                ...
                <a href="https://github.com/primefaces/primeicons/issues" className="font-medium hover:underline text-primary" target={'_blank'} rel="noopener noreferrer">
                    request new icons
                </a>{' '}
