...
export interface TaskContextProps {
    ...
    tasks: Demo.Task[];
    members: Demo.Member[];
    setTasks: React.Dispatch<React.SetStateAction<Demo.Task[]>>;
    setMembers: React.Dispatch<React.SetStateAction<Demo.Member[]>>;
    setDialogConfig: React.Dispatch<React.SetStateAction<Demo.DialogConfig>>;
    setSelectedTask: React.Dispatch<React.SetStateAction<Demo.Task | null>>;
