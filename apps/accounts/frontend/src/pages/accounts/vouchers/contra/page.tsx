...
const modes: { label: string; value: ContraVoucher['mode'] }[] = [
  { label: 'Cash', value: 'Cash' },
  { label: 'Bank', value: 'Bank' },
  { label: 'Transfer', value: 'Transfer' }
];

export default function AccountsVoucherContraRoute() {
  const [voucher, setVoucher] = useState<ContraVoucher>({
    date: new Date(),
    series: 'CON',
    voucherNo: '0001',
    branch: 'HO',
    ...
    allocations: [
      ...
      { id: crypto.randomUUID(), ledger: 'Bank', debit: 0, credit: 0 }
    ]
  });
  ...
  const updateHeader = <K extends keyof ContraVoucher>(key: K, value: ContraVoucher[K]) =>
  ...
  return (
    <div className="grid">
      <div className="col-12">
        <ReportToolbar
          title="Accounts • Voucher Entry — Contra"
          rightExtra={right}
          onExport={(k) => console.log('[Contra Voucher] export', k)}
        />
      </div>
