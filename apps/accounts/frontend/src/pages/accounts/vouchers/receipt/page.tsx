...
const modes: { label: string; value: ReceiptVoucher['mode'] }[] = [
...
export default function AccountsVoucherReceiptRoute() {
  const [voucher, setVoucher] = useState<ReceiptVoucher>({
    ...
    refNo: '',
    narration: '',
    allocations: [{ id: crypto.randomUUID(), ledger: 'Bank', debit: 0, credit: 0 }]
  });
  ...
  const updateHeader = <K extends keyof ReceiptVoucher>(key: K, value: ReceiptVoucher[K]) =>
  ...
  return (
    <div className="grid">
      <div className="col-12">
        <ReportToolbar
          title="Accounts • Voucher Entry — Receipt"
          rightExtra={right}
          onExport={(k) => console.log('[Receipt Voucher] export', k)}
        />
      </div>
        ...
        <Card>
          <div className="grid formgrid p-fluid">
            ...
            <div className="col-12 md:col-3">
              ...
              <Dropdown value={voucher.mode} options={modes} onChange={(e) => updateHeader('mode', e.value)} />
            </div>
            <div className="col-12 md:col-6">
              <label className="block mb-2">Party (Payer)</label>
              <InputText value={voucher.party} onChange={(e) => updateHeader('party', e.target.value)} placeholder="Payer / Customer Name" />
            </div>
            <div className="col-12 md:col-6">
