...
const AuthDashboard = lazy(() => import('./pages/(main)/dashboards/auth-admin/page'));
// Auth Admin Management Components
const UserManagement = lazy(() => import('./pages/(main)/users/list/page'));
const CompanyManagement = lazy(() => import('./pages/(main)/companies/list/page'));
const RoleManagement = lazy(() => import('./pages/(main)/roles/list/page'));
const UserInvitations = lazy(() => import('./pages/(main)/invitations/list/page'));

// Auth Admin Create/Edit Components
const UserCreate = lazy(() => import('./pages/(main)/users/create/page'));
const CompanyCreate = lazy(() => import('./pages/(main)/companies/create/page'));
const RoleCreate = lazy(() => import('./pages/(main)/roles/create/page'));
const InvitationCreate = lazy(() => import('./pages/(main)/invitations/create/page'));

// Auth Admin [id] Components for Edit
const UserForm = lazy(() => import('./pages/(main)/users/[id]/page'));
const CompanyForm = lazy(() => import('./pages/(main)/companies/[id]/page'));
const RoleForm = lazy(() => import('./pages/(main)/roles/[id]/page'));
const InvitationForm = lazy(() => import('./pages/(main)/invitations/[id]/page'));
...
/* Settings - Temporarily commented out until pages are created */
...
/* Documents - Temporarily commented out until pages are created */
...
const AppRoutes = [
    {
        ...
        children: [
            ...
            },
            {
                path: 'companies',
                children: [
                    { path: 'list', element: <CompanyManagement /> },
                    { path: 'create', element: <CompanyCreate /> },
                    { path: ':id', element: <CompanyForm /> }
                ]
            },
            {
                path: 'roles',
                children: [
                    { path: 'list', element: <RoleManagement /> },
            ...
            },
            {
                path: 'invitations',
                children: [
                    { path: 'list', element: <UserInvitations /> },
                    { path: 'create', element: <InvitationCreate /> },
                    { path: ':id', element: <InvitationForm /> }
                ]
            },
            {
                path: 'dashboards',
